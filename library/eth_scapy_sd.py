...
class SD(_SDPacketBase):
    ...
    fields_desc = [
        ...
        PacketListField("entry_array", None, pkt_cls=_SDEntry, length_from=lambda pkt: pkt.len_entry_array),
        FieldLenField("len_option_array", None, length_of="option_array", fmt="!I"),
        PacketListField("option_array", None, pkt_cls=_SDOption, length_from=lambda pkt: pkt.len_option_array)]
